    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <h1 ref={titleRef} className="opacity-0 text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
          ...
          <br />Valuable <span className="animated-gradient-text">Insights</span>
        </h1>
        ...
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce">
          <a href="#about" className="flex items-center justify-center w-10 h-10 rounded-full border border-white/20 transition-colors duration-300 hover:border-accent-blue">
