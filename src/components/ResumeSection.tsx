...
const ResumeSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="glass-card rounded-2xl p-8 md:p-12 border-2 border-accent-blue/20">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
            <div className="col-span-2">
              ...
              <div className="flex flex-wrap gap-4">
                <a 
                  ...
                  onClick={(e) => {
                    e.preventDefault();
                    // This would normally download a resume
            ...
            <div className="relative h-40 md:h-64">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-32 h-32 md:w-48 md:h-48 bg-gradient-to-br from-accent-blue/20 to-accent-blue-light/20 backdrop-blur-md rounded-xl flex items-center justify-center">
          ...
          <div className="mt-8 pt-8 border-t border-white/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="glass-card p-4 rounded-lg text-center hover:border-accent-blue/20 transition-colors border border-transparent">
